...
minpsid_protection_file = appName + "/randomFi/" + appName + "-protection-info/cost-benefit-curve.txt"
file_open = open(minpsid_protection_file, 'r')
