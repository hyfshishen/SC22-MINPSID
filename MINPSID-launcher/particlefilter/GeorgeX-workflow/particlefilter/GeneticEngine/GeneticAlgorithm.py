...
class GeneticAlgorithm:
    ...
    def ga(self):
        ...
        self.init_pop()
        best = self.find_best()
        # Record best info ---START---
        best_info_path = "./memory/total-memory/weighted-cfg-" + best.inputString.replace(' ', '-')
        os.system("cp " + best_info_path + " " + best_info_path.replace("total", "best"))
        # Record best info ----END----
...
if __name__ == '__main__':
    bounds = [[20, 40], [20, 40], [40, 40], [70, 200]]
